...
[![Build Status](https://travis-ci.org/AndroidBootstrap/sg-com-bigspoon-www-bgdashboard.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/sg-com-bigspoon-www-bgdashboard)

This repository contains the source code for the [BGDashboard](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=sg.com.bigspoon.www.BGDashboard).

Please see the [issues](https://github.sg.com.bigspoon.www.BGDashboard/sg-com-bigspoon-www-bgdashboard/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about BGDashboard? Ask away on the [sg-com-bigspoon-www-bgdashboard discussion forum](https://groups.google.com/forum/#!forum/sg-com-bigspoon-www-bgdashboard).

<a href="https://play.google.com/store/apps/details?id=sg.com.bigspoon.www.BGDashboard" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __sg.com.bigspoon.www.BGDashboard__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____sg.com.bigspoon.www.BGDashboard__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.sg.com.bigspoon.www.BGDashboard.R__) will now be renamed
...
signed with a different key.  Manually uninstall BGDashboard from your device and
...
BGDashboard is a result of a template project I've developed over the years as well as
...
BGDashboard is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.sg.com.bigspoon.www.BGDashboard/sg-com-bigspoon-www-bgdashboard/contributors) on
...
[pull requests](https://github.sg.com.bigspoon.www.BGDashboard/sg-com-bigspoon-www-bgdashboard/pulls).
